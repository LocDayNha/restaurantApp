import { StyleSheet, Text, View, Image, TextInput, Pressable, CheckBox, TouchableOpacity, ToastAndroid } from 'react-native'
    ...
    return (
        <View style={{ marginBottom: '5%', marginTop: '5%' }}>
            ...
            <View style={[styles.view2, { marginTop: '5%' }]}>
                ...
                <TextInput placeholder='Re-enter Password' style={styles.inputEmailAndPass} secureTextEntry={true}></TextInput>
            </View>

            <View style={[styles.view2, { marginTop: '7%' }]}>
                <Pressable style={styles.btnLogin}>
                    <Text style={[styles.textLogin, { marginTop: 10, color: '#FFF' }]}>Sign Up</Text>
                </Pressable>
            </View>
